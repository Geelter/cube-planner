...
SMTP_HOST ?= localhost
SMTP_PORT ?= 1025
export PORT ENV DATABASE_URL BASE_URL SMTP_HOST SMTP_PORT SMTP_USER SMTP_PASS SMTP_FROM DISCORD_CLIENT_ID DISCORD_CLIENT_SECRET GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET
